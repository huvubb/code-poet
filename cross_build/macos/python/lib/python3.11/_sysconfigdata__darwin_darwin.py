...
build_time_vars = {
    ...
    "ALT_SOABI": 0,
    "ANDROID_API_LEVEL": 0,
    "AR": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/tools/llvm/bin/llvm-ar",
    "ARFLAGS": "rcs",
    "BASECFLAGS": "",
    "BASECPPFLAGS": "",
    "BASEMODLIBS": "",
    ...
    "BLDSHARED": "clang -pthread -bundle -undefined dynamic_lookup -arch x86_64 -mmacosx-version-min=10.15   -Wl,-headerpad,40",
    "BOOTSTRAP_HEADERS": "\\",
    "BUILDEXE": ".exe",
    ...
    "CC": "clang -pthread",
    "CCSHARED": "",
    "CFLAGS": "-DNDEBUG -g -fwrapv -O3 -Wall -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    ",
    "CFLAGSFORSHARED": "",
    "CFLAGS_ALIASING": "-fno-strict-aliasing",
    "CONFIGFILES": "configure configure.ac acconfig.h pyconfig.h.in Makefile.pre.in",
    "CONFIGURE_CFLAGS": "-O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "CONFIGURE_CFLAGS_NODIST": "-flto -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden",
    "CONFIGURE_CPPFLAGS": "-O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "CONFIGURE_LDFLAGS": "-arch x86_64 -mmacosx-version-min=10.15   -Wl,-headerpad,40",
    "CONFIGURE_LDFLAGS_NODIST": "-flto -Wl,-export_dynamic -g",
    "CONFIGURE_LDFLAGS_NOLTO": "-flto=thin",
    "CONFIG_ARGS": "'--build=aarch64-apple-darwin' '--host=x86_64-apple-darwin' '--prefix=/install' '--with-openssl=/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/tools/deps' '--with-system-expat' '--with-system-libmpdec' '--without-ensurepip' '--enable-static-libpython-for-interpreter' '--enable-shared' '--enable-optimizations' '--with-lto' '--with-build-python=/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/tools/host/bin/python3.11' 'ac_cv_lib_intl_textdomain=no' 'MACHDEP=darwin' 'ac_sys_system=Darwin' 'ac_sys_release=24.6.0' 'ac_cv_func_ptsname_r=no' '--with-dbmliborder=ndbm' 'cross_compiling=yes' 'ac_cv_buggy_getaddrinfo=no' 'ac_cv_file__dev_ptc=no' 'ac_cv_file__dev_ptmx=no' 'ac_cv_pthread=yes' 'ac_cv_aligned_required=no' 'build_alias=aarch64-apple-darwin' 'host_alias=x86_64-apple-darwin' 'PKG_CONFIG=pkg-config --static' 'PKG_CONFIG_PATH=/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/tools/deps/share/pkgconfig:/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/tools/deps/lib/pkgconfig' 'CC=clang' 'CFLAGS=-O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new' 'LDFLAGS=-arch x86_64 -mmacosx-version-min=10.15   -Wl,-headerpad,40' 'CPPFLAGS=-O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new' 'PROFILE_TASK=-m test --pgo -j 9'",
    "CONFINCLUDEDIR": "/install/include",
    "CONFINCLUDEPY": "/install/include/python3.11",
    "COREPYTHONPATH": "",
    "COVERAGE_INFO": "/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/Python-3.11.15/coverage.info",
    "COVERAGE_LCOV_OPTIONS": "--rc lcov_branch_coverage=1",
    "COVERAGE_REPORT": "/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/Python-3.11.15/lcov-report",
    "COVERAGE_REPORT_OPTIONS": "--rc lcov_branch_coverage=1 --branch-coverage --title \"CPython 3.11 LCOV report [commit $(shell )]\"",
    "CPPFLAGS": "-I. -I./Include -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    ",
    "CXX": "clang++",
    ...
    "FREEZE_MODULE": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/tools/host/bin/python3.11 ./Programs/_freeze_module.py",
    "FREEZE_MODULE_BOOTSTRAP": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/tools/host/bin/python3.11 ./Programs/_freeze_module.py",
    ...
    "LDFLAGS": "-arch x86_64 -mmacosx-version-min=10.15   -Wl,-headerpad,40",
    "LDLIBRARY": "libpython3.11.dylib",
    "LDLIBRARYDIR": "",
    "LDSHARED": "clang -pthread -bundle -undefined dynamic_lookup -arch x86_64 -mmacosx-version-min=10.15   -Wl,-headerpad,40",
    "LDVERSION": "3.11",
    "LIBC": "",
    "LIBDEST": "/install/lib/python3.11",
    "LIBDIR": "/install/lib",
    "LIBEXPAT_A": "Modules/expat/libexpat.a",
    "LIBEXPAT_CFLAGS": "-DNDEBUG -g -fwrapv -O3 -Wall -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=code.profclangd -I./Include/internal -I. -I./Include -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "LIBEXPAT_HEADERS": "\\",
    "LIBEXPAT_OBJS": "\\",
    "LIBFFI_INCLUDEDIR": "",
    "LIBM": "",
    "LIBMPDEC_A": "Modules/_decimal/libmpdec/libmpdec.a",
    "LIBMPDEC_CFLAGS": "-DUNIVERSAL=1 -DNDEBUG -g -fwrapv -O3 -Wall -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=code.profclangd -I./Include/internal -I. -I./Include -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "LIBMPDEC_HEADERS": "\\",
    "LIBMPDEC_OBJS": "\\",
    "LIBOBJDIR": "Python/",
    "LIBOBJS": "",
    ...
    "LLVM_PROFDATA": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/tools/llvm/bin/llvm-profdata",
    "LLVM_PROF_ERR": "no",
    "LLVM_PROF_FILE": "LLVM_PROFILE_FILE=\"code-%128m.profclangr\"",
    "LLVM_PROF_MERGER": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/tools/llvm/bin/llvm-profdata merge -output=code.profclangd *.profclangr",
    "LN": "ln",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/Python-3.11.15 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/Python-3.11.15/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/tools/host/bin/python3.11",
    "PYTHON_FOR_BUILD_DEPS": "",
    "PYTHON_FOR_FREEZE": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/tools/host/bin/python3.11",
    "PYTHON_FOR_REGEN": "",
    "PYTHON_HEADERS": "\\",
    "PYTHON_OBJS": "\\",
    "PY_BUILTIN_HASHLIB_HASHES": "\"md5,sha1,sha256,sha512,sha3,blake2\"",
    "PY_BUILTIN_MODULE_CFLAGS": "-DNDEBUG -g -fwrapv -O3 -Wall -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=code.profclangd -I./Include/internal -I. -I./Include -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -DPy_BUILD_CORE_BUILTIN",
    "PY_CFLAGS": "-DNDEBUG -g -fwrapv -O3 -Wall -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    ...
    "PY_CORE_CFLAGS": "-DNDEBUG -g -fwrapv -O3 -Wall -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=code.profclangd -I./Include/internal -I. -I./Include -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -DPy_BUILD_CORE",
    "PY_CORE_LDFLAGS": "-arch x86_64 -mmacosx-version-min=10.15   -Wl,-headerpad,40 -flto -Wl,-export_dynamic -g",
    "PY_CPPFLAGS": "-I. -I./Include -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "PY_ENABLE_SHARED": 1,
    "PY_FORMAT_SIZE_T": "\"z\"",
    "PY_LDFLAGS": "-arch x86_64 -mmacosx-version-min=10.15   -Wl,-headerpad,40",
    "PY_LDFLAGS_NODIST": "-flto -Wl,-export_dynamic -g",
    "PY_LDFLAGS_NOLTO": "-arch x86_64 -mmacosx-version-min=10.15   -Wl,-headerpad,40 -flto=thin",
    "PY_SQLITE_ENABLE_LOAD_EXTENSION": 0,
    "PY_SQLITE_HAVE_SERIALIZE": 1,
    "PY_SSL_DEFAULT_CIPHERS": 1,
    "PY_SSL_DEFAULT_CIPHER_STRING": 0,
    "PY_STDMODULE_CFLAGS": "-DNDEBUG -g -fwrapv -O3 -Wall -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=code.profclangd -I./Include/internal -I. -I./Include -O3 -arch x86_64 -mmacosx-version-min=10.15 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "PY_SUPPORT_TIER": 1,
    "Py_DEBUG": 0,
    "Py_ENABLE_SHARED": 1,
    "Py_HASH_ALGORITHM": 0,
    ...
    "RETSIGTYPE": "void",
    "RUNSHARED": "DYLD_LIBRARY_PATH=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/Python-3.11.15",
    "SCRIPTDIR": "/install/lib",
    "SETPGRP_HAVE_ARG": 0,
    "SHAREDMODS": "Modules/_crypt.cpython-311-darwin.so Modules/_ctypes_test.cpython-311-darwin.so Modules/_dbm.cpython-311-darwin.so Modules/_testbuffer.cpython-311-darwin.so Modules/_testcapi.cpython-311-darwin.so Modules/_testimportmultiple.cpython-311-darwin.so Modules/_testmultiphase.cpython-311-darwin.so Modules/_tkinter.cpython-311-darwin.so",
    "SHELL": "/bin/sh",
    ...
    "TESTOPTS": "",
    "TESTPATH": "",
    "TESTPYTHON": "DYLD_LIBRARY_PATH=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/Python-3.11.15 _PYTHON_PROJECT_BASE=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/Python-3.11.15 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/Python-3.11.15/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/tools/host/bin/python3.11",
    "TESTPYTHONOPTS": "",
    "TESTRUNNER": "DYLD_LIBRARY_PATH=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/Python-3.11.15 _PYTHON_PROJECT_BASE=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/Python-3.11.15 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/Python-3.11.15/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/tools/host/bin/python3.11 ./Tools/scripts/run_tests.py",
    ...
    "abs_builddir": "/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/Python-3.11.15",
    "abs_srcdir": "/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplubpcn7x/Python-3.11.15",
